            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
              <Card className="border-primary/30 bg-card glow-primary">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button onClick={() => window.open("https://discord.gg/TtV26hZEJx", "_blank")} className="w-full glow-primary gap-2 font-semibold text-sm" size="lg"><ShoppingCart className="h-4 w-4" /> Order Now</Button>
