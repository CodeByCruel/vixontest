  ...
  const sections = [
    {
      ...
      content: `By purchasing any hosting plan from VixonCloud, via our website or Discord, you agree to these terms. Failure to follow these rules will result in immediate suspension without a refund.`,
    },
    {
      ...
      <main className="pt-28 pb-20 relative z-10">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/8 px-4 py-1.5 text-xs text-primary mb-6">Legal</div>
