...
const VpsPremium = () => {
 ...
 <Card className="h-full border-primary/15 bg-card/70 card-lift card-theme-vps-amd">
 ...
 <h2 className="text-2xl font-extrabold font-display mb-2">VPS is sold via Discord only </h2>
