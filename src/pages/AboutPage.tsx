...
const values = [
  ...
  { icon: ShieldCheck, emoji: "🛡️", title: "Always protected", desc: "DDoS shielded edges, isolated containers, daily backups." },
      ...
      <section className="container mx-auto px-4 max-w-5xl text-center mb-16">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold font-display tracking-tight">
            We host whatever you <span className="gradient-text">dream up</span> <span className="inline-block animate-bounce-soft">✨</span>
          </h1>
      ...
      <section className="container mx-auto px-4 max-w-5xl">
        <Card className="p-8 bg-gradient-to-br from-primary/10 via-primary/4 to-transparent border-primary/25">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-extrabold font-display mb-3">Come hang out <span>👋</span></h2>
