...
const plans = [
  ...
  { title: "Standard", price: "₹40", unit: "/GB", features: ["AMD EPYC 7K62", "2–32 GB DDR4", "NVMe SSD", "DDoS Shield", "Priority Queue"], popular: true },
  { title: "Premium", price: "₹55", unit: "/GB", features: ["AMD EPYC 9754 96C/192T", "Priority Support", "Dedicated Resources", "Premium Role", "Custom Subdomain"], icon: Crown },
