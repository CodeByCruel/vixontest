...
import { ExternalLink, Users, MessageCircle, Zap, ArrowRight } from "lucide-react";
...
const DiscordBanner = () => {
 ...
 <motion.div
 className="max-w-5xl mx-auto relative rounded-2xl overflow-hidden glass gradient-border p-8 sm:p-12"
 ...
 <p className="text-muted-foreground text-sm max-w-md mx-auto lg:mx-0 mb-6 leading-relaxed">
 Connect with 2,000+ gamers, get instant support, share your builds, and stay updated on new features and exclusive deals. Your server journey starts here.
 </p>
...
>
 ...
 <span className="text-sm font-bold text-foreground">2,000+</span>
